                                        ...
                                        <?php if (isset($user['MaVaiTro']) && (int)$user['MaVaiTro'] === 1): ?>
                                            <td>
                                                <?php if ($yc['TrangThai'] !== 'Đã duyệt'): ?>
                                                    <form method="post" action="actions/yeucaumuon_action.php" onsubmit="return confirm('Bạn có chắc muốn duyệt yêu cầu <?php echo htmlspecialchars($yc['MaYeuCau']); ?> không?');">
